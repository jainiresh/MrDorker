...
const Login = () => {
  ...
  return (
    <div>
      <div className="flex items-center justify-between text-black-500 font-bold mt-5 p-1">
        <Link to={"/register"} className="no-underline text-black hover:underline">
          <div className="cursor-pointer flex items-center text-xs no-underline">
            <MdArrowBackIos />
            Back to register
          </div>
        </Link>
        <div className="cursor-pointer text-xs hover:underline">Need any help?</div>
      </div>
      ...
      >
        <label className="relative">
          <input
            ...
            className="my-2 mx-1 w-[270px] h-[30] xs:w-[360px] xs:h-[40px] md:w-[450px] md:h-[50px] px-6 py-3 rounded-full outline-none border-[1px] border-gray-400 focus:border-black-500 transition duration-200"
          />
        ...
        <button
          type="submit"
          className="w-[270px] h-[30] xs:w-[360px] xs:h-[40px] md:w-[450px] md:h-[50px] p-2 md:p-0  bg-black text-white text-base font-medium md:font-semibold rounded-full mt-5 md:mt-4"
        >
          Submit
        </button>
      </form>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="text-gray-600 mt-2 mb-5">
          ...
          <Link to={"/register"}>
            <span className="text-black font-medium">Register here</span>
          </Link>
        </div>
      </div>
    </div>
