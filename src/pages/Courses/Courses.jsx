        ...
        <>
            {
                isModalOpen ? (
                    ...
                    >
                        <div
                            className="bg-gradient-to-r from-purple-700 via-purple-800 to-purple-900 rounded-lg p-8 shadow-2xl transform transition-transform duration-300 hover:scale-105"
                            style={{
                                width: "90%", // Responsive width
                                maxWidth: "600px", // Ensures it doesn’t exceed screen width
                                maxHeight: "90vh", // Limits height to fit within the viewport
